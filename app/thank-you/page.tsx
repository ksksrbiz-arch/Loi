...
export default function ThankYouPage() {
  return (
    ...
    >
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-darkforest/80 via-darkforest/70 to-darkforest/90" />

      <div className="relative z-10 text-white max-w-xl mx-auto py-16 animate-fade-up">
        {/* Success icon */}
        <div className="w-24 h-24 rounded-full bg-wheat flex items-center justify-center mx-auto mb-8 shadow-wheat shadow-2xl">
          <svg
        ...
        <p className="text-gray-300 text-sm mb-10 leading-relaxed">
          ...
          here to answer your questions and put together a free estimate for your
          operation.
        </p>
